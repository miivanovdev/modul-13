namespace Модуль_13_ДЗ.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Модуль_13_ДЗ.BankContext>
    {
        ...
        protected override void Seed(Модуль_13_ДЗ.BankContext context)
        {
            try
            {
                ...
                var Departments = new List<Departments>()
                {
                    ...
                    new Departments() { Name = "Отдел по работе с юридическими лицами",          Id = 3, InterestRate = 15, MinAmount = 30000,  MinTerm = 12 },
                    new Departments() { Name = "Отдел по работе с привелигированными клиентами", Id = 4, InterestRate = 20, MinAmount = 100000, MinTerm = 18 }
                };
                ...
                {
                    new AccountTypes() { Name = "Физический счет",          Id = 1, DepartmentsRefId = 2 },
                    new AccountTypes() { Name = "Юридический счет",         Id = 2, DepartmentsRefId = 3 },
                    new AccountTypes() { Name = "Привелигированный счет",   Id = 3, DepartmentsRefId = 4, IsCapitalized = true }
                };
                ...
                Debug.WriteLine("отметка 1");
                context.Accounts.AddOrUpdate(Accounts.ToArray());
                Debug.WriteLine("отметка 2");
                context.SaveChanges();
            }

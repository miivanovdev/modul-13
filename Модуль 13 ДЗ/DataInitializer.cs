...
{
    public class DataInitializer : CreateDatabaseIfNotExists<BankEntities>
    {
        protected override void Seed(BankEntities context)
        {
            try
            {               
                ...
                var Departments = new List<Departments>()
                {
                    ...
                    new Departments() { Name = "Отдел по работе с физическими лицами",           Id = 2, InterestRate = 15, MinAmount = 50000,  MinTerm = 6,  AccountType = (int)AccountType.PhysicalAccount },
                    new Departments() { Name = "Отдел по работе с юридическими лицами",          Id = 3, InterestRate = 15, MinAmount = 30000,  MinTerm = 12, AccountType = (int)AccountType.IndividualAccount },
